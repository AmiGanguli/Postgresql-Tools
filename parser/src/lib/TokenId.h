...
enum TokenCategory {
	...
	INTEGER_CONSTANT = 8,
	STRING_CONSTANT = 16,
	BIT_STRING_CONSTANT = 32,
	HEX_STRING_CONSTANT = 64,
	
	KEYWORD_TOKEN = 128,
	
	KW_IS_UNRESERVED = 256,
	KW_IS_RESERVED = 512,
	KW_IS_TYPE_FUNC_NAME = 1024,
	KW_IS_COL_NAME = 2048,
	
	UNRESERVED_KEYWORD = KEYWORD_TOKEN | KW_IS_UNRESERVED,
	RESERVED_KEYWORD = KEYWORD_TOKEN | KW_IS_RESERVED,
	TYPE_FUNC_NAME_KEYWORD = KEYWORD_TOKEN | KW_IS_TYPE_FUNC_NAME,
	COL_NAME_KEYWORD = KEYWORD_TOKEN | KW_IS_COL_NAME,
	
	TOKEN_IS_IGNORED = 4096,
	TOKEN_IS_WHITESPACE = 8192,
	TOKEN_IS_COMMENT = 16384,
	
	WHITESPACE_TOKEN = TOKEN_IS_IGNORED | TOKEN_IS_WHITESPACE,
	COMMENT_TOKEN = TOKEN_IS_IGNORED | TOKEN_IS_COMMENT,
	
	OPERATOR_TOKEN = 32768,
	PARAMETER_TOKEN = 65536,
	ERROR_TOKEN = 131072
